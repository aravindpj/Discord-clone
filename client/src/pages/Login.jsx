    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="text-base text-gray-400 mb-6">we are excited to see you again...</p>
          ...
          <p className="text-gray-400 text-base mt-4">
            Need an account? <Link to="/signup" className="text-blue-400 hover:underline">Register</Link>
          </p>
        </motion.div>
        ...
        >
          ...
          /></motion.div>
          <h2 className='text-xl font-semibold mb-2'>Login with this QR code</h2>
