...
const Sidebar = () => {
  return (
    <div className=" bg-discordDark-400 flex flex-col items-center w-16 px-2 py-2 fixed top-0 bottom-0">
      <button className="bg-discordDark-200 transform cursor-pointer transition-transform hover:scale-110 rounded-full hover:rounded-2xl hover:bg-discordBlue w-12">
      ...
      <div className="flex flex-col gap-2 mt-2">
        <button className="cursor-pointer transform transition-transform hover:scale-110 rounded-full hover:rounded-2xl hover:bg-discordDark-200 w-12">
          <img
